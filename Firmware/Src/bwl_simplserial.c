...
void sserial_send_start(unsigned char portindex){HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_SET);};
void sserial_send_end(unsigned char portindex){HAL_GPIO_WritePin(GPIOA, GPIO_PIN_4, GPIO_PIN_RESET);};
